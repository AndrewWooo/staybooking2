...
import com.laioffer.staybooking.service.GeoCodingService;
...
public class StayService {
    ...
    public StayService(StayRepository stayRepository, LocationRepository locationRepository, ReservationRepository reservationRepository,
                       ImageStorageService imageStorageService, GeoCodingService geoCodingService, StayReservationDateRepository stayReservationDateRepository) {
...
//    }
    ...
    //How to stay?
    /*
    先删除stay,再是location，再是删除picture.
    Pictures 可以通过单独写程序定期删除下
    loop all files in gcs
    check if he url in stay_image table
    if no, delete
     */
}
